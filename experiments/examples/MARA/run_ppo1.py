...
#tf.train.Saver().restore(sess, '/tmp/rosrl/GazeboMARATop3DOFv0Env/ppo1/1000000_nsec/risto_network/mara_ppo1_test_afterIter_680.model') # for the H
tf.train.Saver().restore(sess, '/tmp/rosrl/GazeboMARATop3DOFv0Env/ppo1/1000000_nsec/models/mara_ppo1_test_afterIter_680.model')
