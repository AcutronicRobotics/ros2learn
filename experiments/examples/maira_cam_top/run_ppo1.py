...
#tf.train.Saver().restore(sess, '/tmp/rosrl/GazeboMAIRATop3DOFv0Env/ppo1/1000000_nsec/risto_network/maira_ppo1_test_afterIter_680.model') # for the H
tf.train.Saver().restore(sess, '/tmp/rosrl/GazeboMAIRATop3DOFv0Env/ppo1/1000000_nsec/models/maira_ppo1_test_afterIter_680.model') 
