...
tf.train.Saver().restore(sess, '/tmp/rosrl/GazeboMARATopOrientVisionCollisionv0Env/ppo1/1000000_nsec/models/mara_orient_ppo1_test_afterIter_4801.model') # for the H
