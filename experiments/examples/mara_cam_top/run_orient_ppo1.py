...
tf.train.Saver().restore(sess, '/tmp/rosrl/GazeboMARATopOrientCollisionv0Env/ppo1/1000000_nsec/models/mara_orient_ppo1_test_afterIter_1480.model') # for the H
