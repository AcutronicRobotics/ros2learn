...
model, _ = learn(env)
# learn = lambda e: get_learn_function('ppo2')(
#     env=env_type,
#     network='lstm',
#     value_network = 'copy',
#     noptepochs = 10,
...
# }
#
# # hack because the number of minibatches should be <= nenvs
# alg_kwargs['nminibatches'] = nenvs
#
# seed = 0
...
#     policy = policies.build_policy(env, models.lstm(128))(nbatch=1, nsteps=1)
#
