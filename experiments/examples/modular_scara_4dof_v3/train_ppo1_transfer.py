...
MeanEpRew = pposgd_simple.learn(env, policy_fn,
                    ...
                    optim_batchsize=64, lam=0.95, schedule='linear',restore_model_from_file='/home/rkojcev/baselines_networks/ros1_ppo1/saved_models/ros1_ppo1_afterIter_497.model', save_model_with_prefix='4dof_ppo1_H', outdir=logger.get_dir())
print(MeanEpRew)
