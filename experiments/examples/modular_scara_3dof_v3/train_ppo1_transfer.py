...
MeanEpRew = pposgd_simple.learn(env, policy_fn,
                    ...
                    optim_batchsize=64, lam=0.95, schedule='linear',restore_model_from_file='/home/rkojcev/baselines_networks/networks_paper_launch/GazeboModularScara4DOFv3Env/ppo1/1000000_nsec/4dof_ppo1_H_afterIter_487.model.meta', save_model_with_prefix='4dof_ppo1_H', outdir=logger.get_dir())
print(MeanEpRew)
