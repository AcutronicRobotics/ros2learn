...
tf.train.Saver().restore(sess, '/home/rkojcev/devel/baselines/baselines/experiments/ros1_ppo1_test_O/saved_models/ros1_ppo1_test_O_afterIter_421.model') # for the O
done = False
while True:
